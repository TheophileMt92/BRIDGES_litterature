...
Three complementary search strategies were employed to capture the breadth of relevant literature on spatial models for marine and terrestrial management:
```{r}
#| label: tbl-queries
