...
install.packages("writexl")  # to export results to Excel
...
# Run Query 2: Model types + Socio-ecological systems
...
# Run Query 3: Specific model names
...
# More targeted search - decision support + spatial + marine
query_focused <- oa_fetch(
  entity = "works",
  title_and_abstract.search = "decision support spatial planning marine ecosystem model scenario",
